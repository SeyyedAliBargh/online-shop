...
class Cart:
    ...
    def get_post_price(self):
        ...
        if total_weight == 0:
            ...
            return 30000
        elif 1000 <= total_weight <= 30000:
            return 50000
        elif 30000 <= total_weight <= 50000:
            return 75000
        else:
            return 100000
    ...
    def total_discount(self):
        td = sum(item["price_before_discount"] - item["price"] for item in self.cart.values())
        return td
